...
export default function Magazine() {
  ...
  return (
    <section className="py-8 bg-gradient-to-b from-amber-50 to-orange-50">
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 max-w-4xl mx-auto">
            Explore the diverse coffee-growing regions of India through our
            interactive magazine. Hover over each region to discover their
            unique characteristics and coffee varieties.
          </p>
        </div>
              ...
              <div className="relative w-full aspect-[3/4] rounded-lg shadow-lg overflow-hidden">
                ...
                <div className="absolute inset-0 w-full h-full bg-white border border-gray-200 rounded-lg">
                  <div className="p-4 h-full flex flex-col justify-center items-center text-center">
                    ...
                    <div className="text-xs font-bold text-gray-600 space-y-1 text-left">
                      ...
                      <p>
                        Main intercrops :{" "}
                        <span className="font-medium"> {magazine.harvest}</span>
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <motion.div
                  ...
                  animate={{
                    opacity:
                      hoveredIndex === index ||
                      (clickedIndex === index && window.innerWidth < 1024)
                        ? 0
                        : 1,
                  }}
                  transition={{ duration: 0.3 }}
          ...
          {magazineImages.slice(10).map((magazine, index) => (
            <motion.div
              ...
              onClick={() => {
                ...
                if (window.innerWidth < 1024) {
                  setClickedIndex(
                    clickedIndex === index + 10 ? null : index + 10
                  );
                }
              }}
              whileHover={{ scale: 1.05 }}
                ...
                <motion.div
                  ...
                  animate={{
                    opacity:
                      ...
                      (clickedIndex === index + 10 && window.innerWidth < 1024)
                        ? 0
                        : 1,
                  }}
                  transition={{ duration: 0.3 }}
